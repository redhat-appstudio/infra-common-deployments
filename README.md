...
external-production overlay:
├── all-clusters (IAM + External Secrets Operator)
├── external (Smee)
└── environment-patch (sets environment to "external-production")

internal-staging overlay:
├── all-clusters (IAM + External Secrets Operator)
├── internal (Internal Services)
└── environment-patch (sets environment to "internal-staging")
